...
“billboard_top100.csv” - These are the Top 100 Billboard songs from 1990 to 2019 that are scraped from the Billboard website. 

“spotify_songs.csv” - This is the set of ~19,000 Spotify songs that are downloaded from a Kaggle competition 
...
“FINAL_DATA_2.csv” - This is a .csv file with all of the Spotify features for all of the songs used for the models. 
...
“PopVsClassicalAverages.ipynb” - This is a Jupyter notebook that calculates the averages of a variety of Spotify features for pop versus classical music.  
...
“Initial Models.R” - This model is a .R file that contains the code for the 10 machine learning models(and other graphics) applied on all of the songs. 

“Pop Music.R” - This model is a .R file that contains the code for the 10 machine learning models(and other graphics) applied on all pop songs. 

“Music by Decade.R” - This model is a .R file that contains the code for the 10 machine learning models(and other graphics) applied on all songs from the 2010’s decade. 

“Pop Music in the 2010’s Decade.R” - This model is a .R file that contains the code for the 10 machine learning models(and other graphics) applied on all pop songs from the 2010’s decade.
